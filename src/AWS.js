...
import {LinEquat1, Basics} from './CONTS/LinearAlgebra/LinearEquation.js';
...
const TOPICS = [
  { id: 0, topic: "Basics", subs: [] },
  {id: 1, topic: "Linear Equations", subs: [] },
...
showContents(){
  ...
  switch(this.props.foo){
    case 0:
      return  (PagesBasics.slice(this.state.i,this.state.i+1));
    case 1:
